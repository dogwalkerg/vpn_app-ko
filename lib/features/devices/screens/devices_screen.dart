...
class _DevicesScreenState extends ConsumerState<DevicesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ThemedScaffold(
      appBar: const AppCustomAppBar(title: '设备管理'),
      body: currentTokenAsync.when(
        loading: () => const Center(child: CircularProgressIndicator()),
        error: (e, _) => Center(child: Text('获取设备令牌失败：$e', style: t.typography.body.copyWith(color: c.danger))),
        data: (currentToken) {
          ...
          if (state is FeatureError<List<Device>>) {
            ...
            return Center(child: Text('错误：$message', style: t.typography.body.copyWith(color: c.danger)));
          }
                ...
                children: [
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: Text(
                          '已登录设备：${devices.length} / $maxDevices',
                  ...
                  Expanded(
                    child: RefreshIndicator(
                      ...
                      child: devices.isEmpty
                          ? Center(child: Text('暂无设备', style: t.typography.body.copyWith(color: c.textMuted)))
                          : ListView.separated(
                              ...
                              itemBuilder: (context, i) {
                                ...
                                return ListTileX(
                                  ...
                                  title: '${d.model} (${d.os})',
                                  subtitle: '最后登录：${d.lastSeenUtc.toLocalDate(pattern: "yyyy-MM-dd HH:mm")}',
                                  trailing: isCurrent
                                      ? Tooltip(message: '当前设备', child: Icon(Icons.lock, color: c.textMuted))
                                      : IconButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            if (context.mounted) {
                                              showAppSnackbar(context, text: '设备已移除', type: AppSnackbarType.success);
                                            }
                                          },
                                        ),
                                  onTap: null,
