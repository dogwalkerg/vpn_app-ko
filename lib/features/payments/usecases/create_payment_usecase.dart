...
final createPaymentUseCaseProvider = Provider<CreatePayment>((ref) {
  ...
  return ({required double amount, required PaymentMethod method, int? planId, CancelToken? cancelToken}) {
    return repo.create(amount: amount, method: method, planId: planId, cancelToken: cancelToken);
  };
});
